...
This project is me testing 3 things.

* AngularJS, testing some more
* GitHub REST api
* OAuth and client side OAuth

While these aren't of particular interest, my hope is to make a dashboard to help programmers than want to contribute to open source but don't know where to begin.
